  ...
  <div className='flex flex-col justify-center items-center'>
    ...
    <p className={`text-[#FF621C]  text-center text-[40px] md:text-[60px] ${courgette.className}`}>Delicious</p>
      <div className='flex gap-3'>
        ...
        <Image className='rounded-full shake object-cover' src={"/pizza.jpeg"} width={80} height={50} alt="pizza"/>
        <p className='font-semibold min-h-[50px]'>piporany pizza</p>
        </div>
        <div className='flex-col justify-center gap-1 items-center '>
        <Image className='rounded-full  min-h-[80px] shake object-cover' src={"/cheese.jpg"} width={80} height={50} alt="pizza"/>
        <p className='font-semibold'>grilled cheese</p>
        </div>
        <div className='flex-col justify-center items-center gap-1'>
        <Image className='rounded-full min-h-[80px] shake object-cover' src={"/burger.jpg"} width={80} height={50} alt="pizza"/>
