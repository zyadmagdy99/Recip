    ...
    <div className="mx-auto max-w-screen-2xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div className='md:flex gap-3 hidden items-center'>
            ...
            <p className='text-3xl text-green-400'>Foodix</p>
        </div>
        <ul className="mt-8 flex md:justify-start justify-center gap-6 sm:mt-0 sm:justify-end">
          <li>
            <a
              href="#"
              rel="noreferrer"
      ...
      <div
        className="flex flex-wrap justify-between flex-1 grid-cols-1 gap-8 border-t border-gray-100 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16"
      >
        <div>
      ...
      <p className="text-xs text-gray-500">&copy; 2025. Zyad Magdy. All rights reserved.</p>
    </div>
  </footer>
  )
}
